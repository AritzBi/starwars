...
class PeliculaTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('PREMIERE_DATE', 'PremiereDate', 'DATE', true, null, null);
	...
	{
    $this->addRelation('Participacion', 'Participacion', RelationMap::ONE_TO_MANY, array('id' => 'pelicula_id', ), 'CASCADE', null);
	} // buildRelations()
