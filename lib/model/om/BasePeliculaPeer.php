...
abstract class BasePeliculaPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Pelicula';
	...
	const SUMMARY = 'pelicula.SUMMARY';

	/** the column name for the PREMIERE_DATE field */
	const PREMIERE_DATE = 'pelicula.PREMIERE_DATE';

	/** the column name for the PHOTO field */
	const PHOTO = 'pelicula.PHOTO';

	/** the column name for the SLUG field */
	const SLUG = 'pelicula.SLUG';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Summary', 'PremiereDate', 'Photo', 'Slug', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'summary', 'premiereDate', 'photo', 'slug', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::SUMMARY, self::PREMIERE_DATE, self::PHOTO, self::SLUG, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'summary', 'premiere_date', 'photo', 'slug', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Summary' => 2, 'PremiereDate' => 3, 'Photo' => 4, 'Slug' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'summary' => 2, 'premiereDate' => 3, 'photo' => 4, 'slug' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::SUMMARY => 2, self::PREMIERE_DATE => 3, self::PHOTO => 4, self::SLUG => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'summary' => 2, 'premiere_date' => 3, 'photo' => 4, 'slug' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PeliculaPeer::NAME);
		$criteria->addSelectColumn(PeliculaPeer::SUMMARY);
		$criteria->addSelectColumn(PeliculaPeer::PREMIERE_DATE);
		$criteria->addSelectColumn(PeliculaPeer::PHOTO);
		$criteria->addSelectColumn(PeliculaPeer::SLUG);
	}
	 ...
	 */
	public static function addInstanceToPool(Pelicula $obj, $key = null)
	{
	...
	{
		return $withPrefix ? PeliculaPeer::CLASS_DEFAULT : PeliculaPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Pelicula or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePeliculaPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePeliculaPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePeliculaPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePeliculaPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Pelicula or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePeliculaPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePeliculaPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(PeliculaPeer::ID, $criteria->remove(PeliculaPeer::ID), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePeliculaPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePeliculaPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the pelicula table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += PeliculaPeer::doOnDeleteCascade(new Criteria(PeliculaPeer::DATABASE_NAME), $con);
			$affectedRows += BasePeer::doDeleteAll(PeliculaPeer::TABLE_NAME, $con);
	...
	/**
	 * Method perform a DELETE on the database, given a Pelicula or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += PeliculaPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = PeliculaPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {
			...
			$criteria->add(ParticipacionPeer::PELICULA_ID, $obj->getId());
	 ...
	 */
	public static function doValidate(Pelicula $obj, $cols = null)
	{
		$columns = array();
	...
	{
	  return array(array('name'), array('photo'), array('slug'));
	}
